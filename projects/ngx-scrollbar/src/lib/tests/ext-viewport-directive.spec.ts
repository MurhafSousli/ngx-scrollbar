...
// }
//
// xdescribe('External viewport via scrollViewportDirective', () => {
//
...
//     const attachScrollbarSpy: jasmine.Spy = spyOn(scrollbarCmp.viewportRef.instance, 'attachScrollbars').and.callThrough();
//
...
//     expect(scrollbarCmp.viewportRef.instance.scrollbarsRef).toBeTruthy();
//
...
//
//     const hostViewDestroySpy: jasmine.Spy = spyOn(scrollbarCmp.viewportRef.instance.scrollbarsRef.hostView, 'destroy');
//     fixture.destroy();
