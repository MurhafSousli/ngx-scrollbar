...
describe('External viewport with [NgSyncSpacer]', () => {
  ...
  it('[NgSyncSpacer] should sync spacer dimension with content dimension', async () => {
    ...
    component.contentWidth.set(200);
    ...
    component.contentWidth.set(100);
